...
public class MavenJavaFormatter extends BaseFormatter implements Closeable {
	...
	public static class TestResultPage {
		...
		private void writeHeaderFor(String testName) throws IOException {
			...
			currentWriter.write("</title><meta http-equiv='Content-Type' content='text/html;charset=" + FileUtil.CHARENCODING + "'/>"
	...
	public static class TestResultsSummaryTableRow {
		...
		public String toString() {
			...
			sb.append("<tr class=\"")
					.append(getCssClass(testSummary))
					.append("\"><td>")
					.append("<a href=\"")
					.append(testName)
					.append(".html\">")
					...
					.append("</a>")
					.append("</td><td>")
					.append(testSummary.getRight())
					.append("</td><td>")
					.append(testSummary.getWrong())
					.append("</td><td>")
					.append(testSummary.getExceptions())
					.append("</td></tr>");
			return sb.toString();
		}
